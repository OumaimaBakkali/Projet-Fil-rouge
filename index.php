    ...
    <div class="about-container">
        ...
        <div class="about-content-section">
            <div class="about-text-content">
                <p>
                    At StudySwap, we support students from primary to high school by connecting them
        ...
        <div class="about-content-section reverse">
            <div class="image-container">
                <img
                    ...
                    alt="Student working on laptop with peer collaboration"
                    class="about-illustration" />
            </div>
            <div class="about-text-content">
                <p>
                    By posting their courses, students get help and feedback from peers. We're building a
                    community where learning is shared and success is a team effort.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="ready-container">
            ...
            <div class="illustration-container">
                <img
                    ...
                    alt="Students sharing knowledge with laptops and devices"
                    class="illustration">
            </div>
        </div>
    </section>
